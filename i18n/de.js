(function() {
  ...
  (window._i18n = window._i18n || {}).de = {
    ...
    w5Tip1D: 'Pfeiltasten nutzen oder wischen',
    ...
    w4TagTitle: 'Tags & Filter',
    w4TagCustom: 'Eigenes Tag',
    w4TagFeat1: 'Drei eingebaute Tags: Dringend, Erinnerung, Niedrige Priorität',
    w4TagFeat2: 'Eigene Tags erstellen',
    w4TagFeat3: 'Nach einem oder mehreren Tags filtern',
    ...
    emptyFolderTitle: 'Ordner leeren', 
    emptyFolderMsg: 'Alle Todos in diesem Ordner löschen? Dies kann nicht rückgängig gemacht werden.', 
    showTagsOnTodos: 'Tags auf Todos anzeigen', 
    showTagsOnTodosSub: 'Tag-Labels auf jedem Todo in der Tagesansicht anzeigen'
  };
})();
