(function() {
  ...
  (window._i18n = window._i18n || {}).en = {
    ...
    w5Tip1D: 'Use the arrow buttons or swipe',
    ...
    w4TagTitle: 'Tags & Filters',
    w4TagCustom: 'Custom tag',
    w4TagFeat1: 'Three built-in tags: Urgent, Reminder, Low priority',
    w4TagFeat2: 'Create your own custom tags',
    w4TagFeat3: 'Filter by one or more tags at once',
    ...
    emptyFolderMsg: 'Delete all todos in this folder? This cannot be undone.',
    showTagsOnTodos: 'Show Tags on Todos',
    showTagsOnTodosSub: 'Display tag labels on each todo in the day view'
  };
})();
